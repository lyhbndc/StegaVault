...
/**
 * StegaVault - Collaborator Dashboard (Redesigned)
 * File: collaborator/dashboard.php
 */
...
<head>
    ...
    <title>Collaborator Dashboard - StegaVault</title>
...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen flex">
    ...
    <main class="flex-1 ml-64 flex flex-col">
        ...
        <header class="h-16 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md sticky top-0 z-40 px-8 flex items-center gap-6">
            <h2 class="text-slate-900 dark:text-white text-lg font-bold tracking-tight flex-shrink-0">Collaborator Dashboard</h2>
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
                        ...
                        <?php else: ?>
                            <div class="p-12 text-center">
                                ...
                                <a href="workspace.php" class="mt-3 inline-block text-xs font-semibold text-primary hover:underline">Go to Workspace →</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </section>
    ...
    <script>
        ...
        const _uploadSeenKey = 'sv_new_uploads_seen_collaborator_<?php echo (int)$user['id']; ?>';
        let _lastSeenToken = '';
