...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2026 at 07:18 AM
...
(21, 'Berlin', 'adrienneberlindelacruz9@gmail.com', '$2y$10$Ezrg8QX3OwVLo8bn9zxwWuEi.6f2hP4SWHT6Jh/NIHXI/xvSAYxd2', NULL, 0, 'Berlin Dela Cruz', 'employee', 'pending_activation', NULL, '432f05f728fbfc46fe4eca5394c7cc39ba825a9a790eb5a329e3cc39491a3fc4', NULL, NULL, '2026-03-02 15:33:33', NULL, NULL, 0),
...
--
-- Role-based user separation views
--
...
DROP VIEW IF EXISTS `employee_collaborator_users`;
CREATE VIEW `employee_collaborator_users` AS
SELECT
  `id`,
  `username`,
  `email`,
  ...
  `is_mfa_enabled`
FROM `users`
WHERE `role` IN ('employee', 'collaborator');
COMMIT;
